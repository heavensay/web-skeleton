...
CREATE TABLE `user`  (
  ...
  `password` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '密码',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'test', '123456', '2019-02-18 14:25:29', '2019-02-18 14:25:31');
