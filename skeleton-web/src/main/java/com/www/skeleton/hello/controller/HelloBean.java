package com.www.skeleton.hello.controller;

import com.helix.dict.annotation.Dict;
import com.www.skeleton.hello.service.data.AnimalEnum;
import com.www.skeleton.hello.service.data.CountryEnum;
import com.www.skeleton.hello.service.data.DigitEnum;
import lombok.Data;
